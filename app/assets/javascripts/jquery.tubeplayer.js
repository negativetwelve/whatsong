...
;(function($){
  "use strict";
	...
	var TUBEPLAYER = ".tubeplayer", TUBE_PLAYER_CLASS = "jquery-youtube-tubeplayer", OPTS = "opts"+TUBEPLAYER;
	...
	var defaults = {
		...
		swfobjectURL: "/swfobject.js", // exclude the protocol, it will be read from the 'protocol' property
